...
var SmModal = /*#__PURE__*/function () {
  ...
  _createClass(SmModal, [{
    key: "makeModal",
    value: function makeModal(modalSettings) {
      var _this = this;
      ...
      this.adaptiveModal = modalSettings.adaptiveModal; // Установка стандартных переменных если нету пользовательских
      ...
      $(this.modalSelector).find('.sm-modal-overlay').attr('style', this.overlay); // Инициализация классов анимации
      ...
      $(this.modalSelector).on('click', '.sm-modal-overlay', function (e) {
        _this.closeModal();
